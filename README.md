...
-60W DC motor (e.g., JGB37-555 60W)
-Raspberry Pi (e.g., Raspberry Pi Zero 2)
-Motor-compatible motor driver (e.g., Ticha Dual Motor Driver Module Board, 15A)
-Current sensor (e.g., INA219)
-60W, 12V power supply (e.g., Meanwell LPV-60-12)
-1 spool of PLA (total material usage should be around 698 grams)
